...
_See code: [lib/commands/auth.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/auth.js)_
...
_See code: [lib/commands/init.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/init.js)_
...
_See code: [lib/commands/list-release.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/list-release.js)_
...
_See code: [lib/commands/release.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/release.js)_
...
_See code: [lib/commands/rollback.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/rollback.js)_
...
_See code: [lib/commands/start.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/start.js)_
...
_See code: [lib/commands/unpublish.js](https://github.com/vikadata/widget-cli/blob/v0.1.0/lib/commands/unpublish.js)_
<!-- commandsstop -->
